...
export default function PhaseCard({ phase }: { phase: Phase }) {
  return (
    <div className="flex w-full items-stretch">
      ...
      <div className="flex flex-1 items-center gap-6 rounded-r-xl border border-paper-border bg-paper px-6 py-6 shadow-[0_4px_18px_-6px_rgba(46,42,31,0.08)] sm:gap-16 sm:px-12 sm:py-7">
